	...
	onMapSingleClick """";";
		...
		//hint "pause";
			...
			if (clic1) then
			{
				...
				call compile format["
				_code={
				if (isserver) then {[[%1,%2,0],""%3"",%4,%5,%6] execVM ""Computer\console\fillvehicles.sqf"";};
				};
				",spawn_x,spawn_y,local_var_console_valid_camp,local_radius,local_var_console_valid_side,local_console_unit_moral];
